...
#
#NUNALIIT_CMD=
NUNALIIT_BIN_DIR=/home/roikle/git/nunaliit_master/nunaliit2-couch-sdk/target/appassembler/bin
NUNALIIT_PID=/var/lock/nunaliit-testatlas.pid
#NUNALIIT_USER=
NUNALIIT_ATLAS_DIR=/home/roikle/git/nunaliit_hamburgermenu/.
NUNALIIT_ATLAS_NAME=testatlas


# Include external configuration to override default values
if [ -e "/home/roikle/git/nunaliit_hamburgermenu/./extra/config.sh" ]; then
	source "/home/roikle/git/nunaliit_hamburgermenu/./extra/config.sh"
fi
